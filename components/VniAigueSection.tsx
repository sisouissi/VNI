    ...
    <div className="overflow-x-auto my-4">
        <table className="w-full text-left border-collapse text-sm">
            ...
            <tbody>
                ...
                <tr className="bg-slate-50"><td className="border p-3 font-bold">FiO₂</td><td colSpan={2} className="border p-3">Titrer pour une <strong>SpO₂ cible > 90%</strong> (ou 88-92% pour la BPCO).</td></tr>
